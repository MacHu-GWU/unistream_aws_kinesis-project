# -*- coding: utf-8 -*-
#
# unistream_aws_kinesis documentation build configuration file, created by
...
package_name = "unistream_aws_kinesis"
...
# Add data for Jinja2
try:
    from unistream_aws_kinesis.docs import doc_data
except:
    doc_data = dict()
